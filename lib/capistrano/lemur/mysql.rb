Capistrano::Configuration.instance.load do
  ...
  namespace :mysql do
    ...
    desc "Create default db and user. TODO: Make this idempotent"
    ...
    desc "Capistrano override: seed the database on already deployed code"
